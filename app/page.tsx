      ...
      <section className="guidance-shell" id="how-it-works">
        <div className="guidance-grid">
          ...
          <div className="moments" id="everyday">
            ...
            <div className="privacy-banner" id="privacy"><span><LockIcon /></span><div><strong>Your privacy comes first</strong><p>CyberFish is designed to analyze without storing what you submit.</p></div></div>
          </div>
        </div>
      </section>
